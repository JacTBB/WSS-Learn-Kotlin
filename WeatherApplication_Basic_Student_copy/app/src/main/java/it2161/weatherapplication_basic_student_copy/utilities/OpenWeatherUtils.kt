package it2161.weatherapplication_basic_student_copy.utilities

import android.content.Context
import android.util.Log
import it2161.weatherapplication_basic_student_copy.R
...
class OpenWeatherUtils{
    ...
    companion object {
        ...
        private val LOG_TAG = OpenWeatherUtils::class.java.getSimpleName()
        /**
         ...
         * "21°C"
         */
        fun formatTemperature(context: Context, inTemperature: Double): String {
        ...
        fun formatHighLows(context: Context, high: Double, low: Double): String {
            val roundedHigh = Math.round(high).toDouble()
            val roundedLow = Math.round(low).toDouble()

            val formattedHigh = formatTemperature(context, roundedHigh)
            val formattedLow = formatTemperature(context, roundedLow)
         ...
         */
        fun getFormattedWind(context: Context, inWindSpeed: Float, degrees: Float): String {
            var windSpeed = inWindSpeed
